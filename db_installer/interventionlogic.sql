...
DROP TABLE IF EXISTS `descr_type`;
...
CREATE TABLE `inv_prio` (
  ...
  PRIMARY KEY (`id`),
  KEY `obj_inv_fk_idx` (`obj_id`),
  CONSTRAINT `obj_inv_fk` FOREIGN KEY (`obj_id`) REFERENCES `objective` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `objective` (
  ...
  PRIMARY KEY (`id`),
  KEY `eu_pr_obj_idx` (`eu_id`),
  CONSTRAINT `eu_pr_obj` FOREIGN KEY (`eu_id`) REFERENCES `eu_prio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `prio_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prio_data` (
  ...
  `description` text,
  PRIMARY KEY (`box_id`),
  KEY `prio_data_fk_idx` (`up_id`),
  KEY `prio_data_fk_indx` (`up_id`),
  CONSTRAINT `prio_data_fk` FOREIGN KEY (`up_id`) REFERENCES `user_prio` (`up_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `prio_descr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prio_descr` (
  `descr_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `up_id` bigint(20) NOT NULL,
  `descr_type` int(1) NOT NULL,
  `descr_text` text,
  PRIMARY KEY (`descr_id`),
  KEY `prio_descr_fk_idx` (`up_id`),
  KEY `prio_descr_fk_indx` (`up_id`),
  CONSTRAINT `prio_descr_fk` FOREIGN KEY (`up_id`) REFERENCES `user_prio` (`up_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `prio_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prio_types` (
  ...
  KEY `logic_parent_fk_idx` (`parent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `user_prio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_prio` (
  ...
  PRIMARY KEY (`up_id`),
  KEY `up_inv_fk_idx` (`inv_id`),
  CONSTRAINT `up_inv_fk` FOREIGN KEY (`inv_id`) REFERENCES `inv_prio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
